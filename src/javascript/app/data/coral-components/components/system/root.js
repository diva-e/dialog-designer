      ...
      <div class="coral-Form--vertical cq-dialog foundation-form foundation-layout-form _coral-Dialog _coral-Dialog--noBackdrop is-open">
        ...
        <coral-dialog-content id="dialog-preview-content" class="_coral-Dialog-content">
          <div class="cq-dialog-content">
            <drop-target data-accept="multifield,fieldset,panel,tabview,datepicker,hidden,numberfield,richtext,textarea,textfield,buttongroup,checkbox,radio,select,switchfield,fileupload,pathbrowser,pathfield,alerthint,anchorbutton,heading," data-name="content" />
          </div>
